...
## Logo — IDENTIDAD CROMÁTICA PROTEGIDA

El logo del cliente tiene una identidad visual que NO debe modificarse bajo ninguna circunstancia.

REGLAS DEL LOGO:
- El logo se superpone en post-proceso sobre la imagen generada — NO lo incluyas en el prompt de FLUX
- NO describir el logo en el prompt
- NO sugerir cambios de color, inversión, ni modificación alguna del logo
- Si el fondo donde cae el logo es oscuro, el sistema ajustará automáticamente el contraste con una sombra o halo — los colores originales del logo siempre se preservan
- En el campo "logo_position" indicar solo la posición: top-left, top-right, bottom-left, bottom-right
