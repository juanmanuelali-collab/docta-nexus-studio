...
// Tercera opción de "Descripción creativa". Genera una especificación visual
// rica a partir de un brief de texto. Este JSON se suma como CONTEXTO EXTRA
// para Claude en runAgent — no reemplaza ctas, textPositions, ni el .md del cliente.
...
Example:
Incorrect: "Do not place objects on the right side."
Correct: "Create a clean low-complexity visual area on the right side suitable for future graphic overlays."
...
async function callCreativeDirector(briefText, textPositions) {
  ...
  // Las zonas de texto ya fueron definidas por el usuario en el canvas — son un HECHO,
  // no algo a proponer. El Director IA debe diseñar la escena alrededor de ellas.
  ...
  // Extraer el texto de salida del array de output items
