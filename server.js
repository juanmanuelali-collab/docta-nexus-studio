...
⚠ IGNORAR COMPLETAMENTE cualquier logo, marca, isotipo o texto de marca que aparezca en las fotos del producto. Esos logos pertenecen al contexto original de la foto y NO deben describirse, mencionarse ni replicarse en el prompt de Flux.

${logoBase64 ?
`El usuario adjuntó su logo. Este logo se superpone en post-proceso DESPUÉS de que Flux genera la imagen.
NO incluir el logo en el prompt de Flux bajo ningún concepto.
Solo indicá logo_position: top-left, top-right, bottom-left o bottom-right según la composición.` :
`Sin logo adjunto. No mencionar ni replicar ningún logo visible en las fotos del producto.`}
...
Respondé ÚNICAMENTE con JSON válido (sin markdown, sin backticks):
{
  ...
  "texts": [
    { "content": "texto exacto 1", "style": "bold white sans-serif title", "position": "upper center area" },
    { "content": "texto exacto 2", "style": "white sans-serif promo", "position": "lower center area" }
  ],
  "logo_position": "top-left|top-right|bottom-left|bottom-right",
  "composition_note": "descripción de la composición final"
}

IMPORTANTE sobre el campo \"texts\" (nivel raíz):\n- Debe contener los MISMOS textos que van dentro del background_prompt.\n- Los \"content\" son EXACTAMENTE los textos del usuario — sin alterar ni un carácter.\n- \"style\" describe el rol visual: usa 'title' para el principal, 'promo' para el secundario, 'badge' o 'pill' para CTA con fondo redondeado.\n- \"position\" usa estas palabras clave combinadas: upper/lower/center + left/center/right + area.\n- Este campo lo usa el sistema de canvas para renderizar los textos directamente sobre la imagen.\n`;
  ...
  const msg = 'Instrucción creativa del usuario: ' + (userPrompt || 'No especificada') + '\n' +
    ...
    'Logo del cliente: ' + (logoBase64 ? 'SÍ (adjunto por el usuario) — se superpone en post-proceso, NO incluir en prompt de Flux. IGNORAR cualquier logo visible en las fotos del producto.' : 'NO — IGNORAR cualquier logo visible en las fotos del producto, no replicarlo.') + '\n' +
